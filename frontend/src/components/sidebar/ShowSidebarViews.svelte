...
<div class="flex flex-col gap-4">
    ...
    <div class="flex justify-between items-center gap-4">
        <button
            ...
            class="flex-1 px-4 py-2 bg-muted rounded-lg text-sm font-semibold text-foreground hover:bg-primary-dark disabled:opacity-50 disabled:cursor-not-allowed"
        >
            Zurück
        </button>
